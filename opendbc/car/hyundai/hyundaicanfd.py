...
def create_steering_messages(packer, CP, CAN, enabled, lat_active, apply_torque, apply_angle, lkas_icon, force_lfa: bool = False):
  values = {
    "LKA_OptUsmSta": 2,
  ...
  if CP.flags & HyundaiFlags.CANFD_LKA_STEERING:
    ...
    if CP.openpilotLongitudinalControl or force_lfa:
