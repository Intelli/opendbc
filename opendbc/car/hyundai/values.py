...
class CarControllerParams:
  ...
  # EV9 parallel parking mode thresholds (seconds, m/s, degrees)
  PARKING_MODE_ENTRY_SPEED_MIN = 1.0 * CV.KPH_TO_MS
  PARKING_MODE_ENTRY_SPEED_MAX = 20.0 * CV.KPH_TO_MS
  PARKING_MODE_EXIT_SPEED_MIN = 0.1 * CV.KPH_TO_MS
  PARKING_MODE_EXIT_SPEED_MAX = 20.0 * CV.KPH_TO_MS
  PARKING_MODE_ENTRY_ANGLE_DEG = 120.0
  PARKING_MODE_EXIT_ANGLE_DEG = 119.0
  PARKING_MODE_MAX_ANGLE_DEG = 176.7
  PARKING_MODE_MAX_DURATION = 2.0
  PARKING_MODE_REENGAGE_DELAY = 1.5
  PARKING_MODE_TARGET_SPEED_MAX = 20.0 * CV.KPH_TO_MS
  PARKING_MODE_PATH_LOOKAHEAD_S = 5.0
  PARKING_MODE_BRAKE_HOLD_SPEED = 0.05
  PARKING_MODE_MIN_ACTIVE_SPEED = 1.0 * CV.KPH_TO_MS
  APRK_COMMAND_STATE_STANDBY = 0x02
  APRK_COMMAND_STATE_ACTIVE = 0x4B
  APRK_COMMAND_PHASE_STANDBY = 0x01
  APRK_COMMAND_PHASE_ACTIVE = 0x06
  APRK_ENABLE_MASK = 0x02
  APRK_PATH_STEP = 12
  APRK_STATUS_WORD_STANDBY = 0x0303
  APRK_STATUS_WORD_ACTIVE = 0x0315
  APRK_SLOT_SIDE_RIGHT = 6
  APRK_SLOT_SIDE_LEFT = 9
  APRK_SLOT_SIDE_UNSPECIFIED = 0
  APRK_PATH_DISTANCE_MAX = 2.55
  APRK_CURVATURE_SCALE = 500.0
