...
class HyundaiSafetyFlags(IntFlag):
  ...
  CANFD_FORCE_LKA_STEER_MSG = 2048
  CANFD_FORCE_LKA_STEER_MSG_ALT = 4096
...
ANGLE_STEERING_CMD_PATH_AUTO = "auto"
ANGLE_STEERING_CMD_PATH_FORCE_LFA = "force_lfa"
ANGLE_STEERING_CMD_PATH_FORCE_LKAS = "force_lkas"
ANGLE_STEERING_CMD_PATH_FORCE_LKAS_ALT = "force_lkas_alt"
ANGLE_STEERING_CMD_PATH_VALID = {
  ANGLE_STEERING_CMD_PATH_AUTO,
  ANGLE_STEERING_CMD_PATH_FORCE_LFA,
  ANGLE_STEERING_CMD_PATH_FORCE_LKAS,
  ANGLE_STEERING_CMD_PATH_FORCE_LKAS_ALT,
}

ANGLE_STEERING_CMD_PATH_PARAM_AUTO = 0
ANGLE_STEERING_CMD_PATH_PARAM_FORCE_LFA = 1
ANGLE_STEERING_CMD_PATH_PARAM_FORCE_LKAS = 2
ANGLE_STEERING_CMD_PATH_PARAM_FORCE_LKAS_ALT = 3
ANGLE_STEERING_CMD_PATH_PARAM_MIN = ANGLE_STEERING_CMD_PATH_PARAM_AUTO
ANGLE_STEERING_CMD_PATH_PARAM_MAX = ANGLE_STEERING_CMD_PATH_PARAM_FORCE_LKAS_ALT
ANGLE_STEERING_CMD_PATH_FROM_PARAM = {
  ANGLE_STEERING_CMD_PATH_PARAM_AUTO: ANGLE_STEERING_CMD_PATH_AUTO,
  ANGLE_STEERING_CMD_PATH_PARAM_FORCE_LFA: ANGLE_STEERING_CMD_PATH_FORCE_LFA,
  ANGLE_STEERING_CMD_PATH_PARAM_FORCE_LKAS: ANGLE_STEERING_CMD_PATH_FORCE_LKAS,
  ANGLE_STEERING_CMD_PATH_PARAM_FORCE_LKAS_ALT: ANGLE_STEERING_CMD_PATH_FORCE_LKAS_ALT,
}


def get_angle_steering_cmd_path_from_param(param_value: int) -> str:
  try:
    path = ANGLE_STEERING_CMD_PATH_FROM_PARAM[int(param_value)]
  except (KeyError, TypeError, ValueError):
    return ANGLE_STEERING_CMD_PATH_AUTO

  if path not in ANGLE_STEERING_CMD_PATH_VALID:
    return ANGLE_STEERING_CMD_PATH_AUTO
  return path
