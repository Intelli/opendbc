...
class CarControllerParams:
  ...
  PARKING_MODE_ENTRY_SPEED_MIN = 0.5 * CV.KPH_TO_MS
  PARKING_MODE_ENTRY_SPEED_MAX = 20.0 * CV.KPH_TO_MS
  PARKING_MODE_EXIT_SPEED_MIN = 0.3 * CV.KPH_TO_MS
  PARKING_MODE_EXIT_SPEED_MAX = 22.0 * CV.KPH_TO_MS
  PARKING_MODE_ENTRY_ANGLE_DEG = 118.0
  PARKING_MODE_EXIT_ANGLE_DEG = 105.0
  PARKING_MODE_MAX_ANGLE_DEG = 176.7
  PARKING_MODE_MAX_DURATION = 0.8
  PARKING_MODE_REENGAGE_DELAY = 0.5
